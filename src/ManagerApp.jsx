      ...
      const eligible = workers
        ...
        .sort((a, b) => {
          ...
          if (a.seniority === b.seniority) {
            ...
            return (0.6 * loadRatioA + 0.4 * diversityA) - (0.6 * loadRatioB + 0.4 * diversityB);
          }
...
export default function ManagerApp() {
  ...
  const generate = () => {
    ...
    const {schedule:s, counts:c} = smartGenerate(workers, shifts, constraints, year, month, active);
    setSchedule(s);
    setCounts(c);
  };
          ...
          <div>
            ...
            {!schedule ? (
              <Card style={{textAlign:"center",padding:60}}>
                ...
                <div style={{color:"#64748B",fontSize:14}}>לחץ ⚡ לייצור תורנות</div>
              </Card>
            ) : (
